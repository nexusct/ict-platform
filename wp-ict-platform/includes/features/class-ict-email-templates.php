...
<p><a href="{message_link}">View Message</a></p>',
    ...
    public function register_rest_routes() {
        ...
        register_rest_route( $namespace, '/email-templates/(?P<id>\d+)', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        // By slug.
        register_rest_route( $namespace, '/email-templates/slug/(?P<slug>[a-z0-9_-]+)', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Preview.
        register_rest_route( $namespace, '/email-templates/(?P<id>\d+)/preview', array(
            'methods'             => WP_REST_Server::CREATABLE,
        ...
        // Send test.
        register_rest_route( $namespace, '/email-templates/(?P<id>\d+)/test', array(
            'methods'             => WP_REST_Server::CREATABLE,
        ...
        // Duplicate.
        register_rest_route( $namespace, '/email-templates/(?P<id>\d+)/duplicate', array(
            'methods'             => WP_REST_Server::CREATABLE,
        ...
        // Placeholders.
        register_rest_route( $namespace, '/email-templates/placeholders', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Categories.
        register_rest_route( $namespace, '/email-templates/categories', array(
            'methods'             => WP_REST_Server::READABLE,
    ...
    public function rest_update_template( $request ) {
        ...
        $fields = array(
            ...
            'from_name', 'from_email', 'reply_to', 'cc', 'bcc', 'is_active'
        );
    ...
    private function get_sample_data() {
        ...
        return array_merge( $this->get_default_data(), array(
