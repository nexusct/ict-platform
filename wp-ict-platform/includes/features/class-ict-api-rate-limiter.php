...
class ICT_API_Rate_Limiter {
    ...
    public function register_rest_routes() {
        ...
        // Rate limit status.
        register_rest_route( $namespace, '/rate-limit/status', array(
        ...
        // Rules management.
        register_rest_route( $namespace, '/rate-limit/rules', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( $namespace, '/rate-limit/rules/(?P<id>\d+)', array(
            array(
        ...
        // Whitelist/blacklist.
        register_rest_route( $namespace, '/rate-limit/list', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( $namespace, '/rate-limit/list/(?P<id>\d+)', array(
            'methods'             => WP_REST_Server::DELETABLE,
        ...
        // Analytics.
        register_rest_route( $namespace, '/rate-limit/analytics', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Reset limits.
        register_rest_route( $namespace, '/rate-limit/reset', array(
            'methods'             => WP_REST_Server::CREATABLE,
    ...
    public function rest_update_rule( $request ) {
        ...
        $fields = array(
            'name', 'endpoint_pattern', 'identifier_type', 'role',
            'requests_per_minute', 'requests_per_hour', 'requests_per_day',
            'burst_limit', 'priority', 'is_active'
        );
    ...
    public function rest_get_analytics( $request ) {
        ...
        // Requests by hour.
        $stats['by_hour'] = $wpdb->get_results( $wpdb->prepare(
