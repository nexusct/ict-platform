...
class ICT_GPS_Tracking {
    ...
    public function register_routes() {
        // Location tracking
        register_rest_route( 'ict/v1', '/gps/location', array(
            array(
        ...
        register_rest_route( 'ict/v1', '/gps/locations', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array( $this, 'get_locations' ),
            'permission_callback' => array( $this, 'check_manager_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/gps/users/(?P<user_id>\d+)/locations', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array( $this, 'get_user_locations' ),
            'permission_callback' => array( $this, 'check_manager_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/gps/users/(?P<user_id>\d+)/current', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array( $this, 'get_user_current_location' ),
            'permission_callback' => array( $this, 'check_manager_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/gps/team/current', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Geofencing
        register_rest_route( 'ict/v1', '/geofences', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( 'ict/v1', '/geofences/(?P<id>\d+)', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( 'ict/v1', '/geofences/check', array(
            'methods'             => WP_REST_Server::CREATABLE,
        ...
        // Project job sites
        register_rest_route( 'ict/v1', '/projects/(?P<project_id>\d+)/jobsite', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( 'ict/v1', '/gps/trail', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Mileage tracking
        register_rest_route( 'ict/v1', '/gps/mileage', array(
            'methods'             => WP_REST_Server::READABLE,
