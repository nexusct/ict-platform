...
class ICT_Warranty_Tracker {
	...
	public function register_rest_routes() {
		...
		register_rest_route(
			$namespace,
			'/warranties/(?P<warranty_id>\d+)/claims',
			array(
				array(
					'methods'             => WP_REST_Server::READABLE,
		...
		register_rest_route(
			$namespace,
			'/warranties/(?P<warranty_id>\d+)/documents',
			array(
				array(
					'methods'             => WP_REST_Server::READABLE,
	...
	public function rest_get_warranty( $request ) {
		...
		// Get claims.
		$warranty->claims = $wpdb->get_results(
			$wpdb->prepare(
		...
		// Get documents.
		$warranty->documents = $wpdb->get_results(
			$wpdb->prepare(
