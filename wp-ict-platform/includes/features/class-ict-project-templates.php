...
class ICT_Project_Templates {
    ...
    public function register_routes() {
        register_rest_route( 'ict/v1', '/project-templates', array(
            array(
        ...
        register_rest_route( 'ict/v1', '/project-templates/(?P<id>\d+)', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( 'ict/v1', '/project-templates/(?P<id>\d+)/apply', array(
            'methods'             => WP_REST_Server::CREATABLE,
            'callback'            => array( $this, 'apply_template' ),
            'permission_callback' => array( $this, 'check_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/projects/(?P<id>\d+)/save-as-template', array(
            'methods'             => WP_REST_Server::CREATABLE,
    ...
    public function apply_template( $request ) {
        ...
        $project_data = array_merge( $template_data, array(
            'name'           => $project_name,
            'client_id'      => $client_id,
        ...
        if ( ! empty( $milestones ) ) {
            ...
            foreach ( $milestones as $index => $milestone ) {
                ...
                $wpdb->insert( $milestones_table, array(
