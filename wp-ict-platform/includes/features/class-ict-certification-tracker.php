...
class ICT_Certification_Tracker {
    ...
    public function register_rest_routes() {
        ...
        // Certification types.
        register_rest_route( $namespace, '/certification-types', array(
            array(
        ...
        // User certifications.
        register_rest_route( $namespace, '/certifications', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( $namespace, '/certifications/(?P<id>\d+)', array(
            array(
        ...
        // User certifications.
        register_rest_route( $namespace, '/users/(?P<user_id>\d+)/certifications', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Training records.
        register_rest_route( $namespace, '/training', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( $namespace, '/certifications/expiring', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( $namespace, '/projects/(?P<project_id>\d+)/cert-requirements', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        // Compliance check.
        register_rest_route( $namespace, '/projects/(?P<project_id>\d+)/compliance-check', array(
            'methods'             => WP_REST_Server::READABLE,
        ...
        // Skills matrix.
        register_rest_route( $namespace, '/skills-matrix', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( $namespace, '/users/(?P<user_id>\d+)/skills', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        // Dashboard stats.
        register_rest_route( $namespace, '/certifications/stats', array(
            'methods'             => WP_REST_Server::READABLE,
    ...
    public function rest_get_certifications( $request ) {
        ...
        $count_sql = str_replace( 'SELECT c.*, ct.name as cert_type_name, ct.code as cert_code, ct.category,
                u.display_name as user_name', 'SELECT COUNT(*)', $sql );
    ...
    public function rest_create_certification( $request ) {
        ...
        $cert_type = $wpdb->get_row( $wpdb->prepare(
    ...
    public function rest_update_certification( $request ) {
        ...
        $fields = array(
            ...
            'issuing_authority', 'verification_url', 'document_path', 'notes'
        );
    ...
    public function rest_get_user_certifications( $request ) {
        ...
        $mandatory = $wpdb->get_results( $wpdb->prepare(
    ...
    public function rest_check_compliance( $request ) {
        ...
        foreach ( $requirements as $req ) {
            ...
            if ( ! empty( $team_members ) ) {
                ...
                $certified_count = $wpdb->get_var( $wpdb->prepare(
