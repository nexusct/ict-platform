...
class ICT_Invoice_Generator {
    ...
    public function register_rest_routes() {
        ...
        register_rest_route( $namespace, '/invoices/from-project/(?P<project_id>\d+)', array(
            'methods'             => WP_REST_Server::CREATABLE,
            'callback'            => array( $this, 'rest_create_from_project' ),
            'permission_callback' => array( $this, 'check_manage_permission' ),
        ) );

        register_rest_route( $namespace, '/invoices/from-quote/(?P<quote_id>\d+)', array(
            'methods'             => WP_REST_Server::CREATABLE,
            'callback'            => array( $this, 'rest_create_from_quote' ),
            'permission_callback' => array( $this, 'check_manage_permission' ),
        ) );

        register_rest_route( $namespace, '/invoices/from-time-entries', array(
            'methods'             => WP_REST_Server::CREATABLE,
        ...
        // Actions.
        register_rest_route( $namespace, '/invoices/(?P<id>\d+)/send', array(
            'methods'             => WP_REST_Server::CREATABLE,
            'callback'            => array( $this, 'rest_send_invoice' ),
            'permission_callback' => array( $this, 'check_manage_permission' ),
        ) );

        register_rest_route( $namespace, '/invoices/(?P<id>\d+)/duplicate', array(
            'methods'             => WP_REST_Server::CREATABLE,
            'callback'            => array( $this, 'rest_duplicate_invoice' ),
            'permission_callback' => array( $this, 'check_manage_permission' ),
        ) );

        register_rest_route( $namespace, '/invoices/(?P<id>\d+)/credit-note', array(
            'methods'             => WP_REST_Server::CREATABLE,
        ...
        // Payments.
        register_rest_route( $namespace, '/invoices/(?P<invoice_id>\d+)/payments', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        // Recurring.
        register_rest_route( $namespace, '/recurring-invoices', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        // Stats.
        register_rest_route( $namespace, '/invoices/stats', array(
            'methods'             => WP_REST_Server::READABLE,
    ...
    public function rest_update_invoice( $request ) {
        ...
        $fields = array(
            ...
            'client_tax_id', 'tax_rate', 'discount_type', 'discount_value',
