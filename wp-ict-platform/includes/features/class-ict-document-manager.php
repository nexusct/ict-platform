...
class ICT_Document_Manager {
    ...
    public function register_routes() {
        register_rest_route( 'ict/v1', '/documents', array(
            array(
        ...
        register_rest_route( 'ict/v1', '/projects/(?P<project_id>\d+)/documents', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array( $this, 'get_project_documents' ),
            'permission_callback' => array( $this, 'check_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/documents/(?P<id>\d+)', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( 'ict/v1', '/documents/(?P<id>\d+)/download', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array( $this, 'get_download_url' ),
            'permission_callback' => array( $this, 'check_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/documents/(?P<id>\d+)/versions', array(
            array(
                'methods'             => WP_REST_Server::READABLE,
        ...
        register_rest_route( 'ict/v1', '/documents/categories', array(
            'methods'             => WP_REST_Server::READABLE,
            'callback'            => array( $this, 'get_categories' ),
            'permission_callback' => array( $this, 'check_permission' ),
        ) );

        register_rest_route( 'ict/v1', '/documents/search', array(
            'methods'             => WP_REST_Server::READABLE,
