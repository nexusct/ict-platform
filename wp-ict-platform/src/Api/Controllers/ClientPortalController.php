...
class ClientPortalController extends AbstractController
{
    ...
    public function registerRoutes(): void
    {
        ...
        register_rest_route(
            ...
            [
                ...
                'callback'            => [$this, 'getClientProjects'],
                'permission_callback' => [$this, 'isClientAuthenticated'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [$this, 'getProjectDetails'],
                'permission_callback' => [$this, 'canAccessProject'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [$this, 'getProjectTimeline'],
                'permission_callback' => [$this, 'canAccessProject'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [$this, 'getProjectInvoices'],
                'permission_callback' => [$this, 'canAccessProject'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::CREATABLE,
                'callback'            => [$this, 'createSupportRequest'],
                'permission_callback' => [$this, 'isClientAuthenticated'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [$this, 'getSupportRequests'],
                'permission_callback' => [$this, 'isClientAuthenticated'],
            ]
        );
    ...
    public function submitApproval(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        if ($approved) {
            ...
            if ($signature_data) {
                $wpdb->insert(ICT_SIGNATURES_TABLE, [
    ...
    public function updateProfile(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        $updateable = ['first_name', 'last_name', 'display_name'];
        $meta_fields = ['company', 'phone', 'address'];
