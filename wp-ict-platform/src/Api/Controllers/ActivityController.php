...
class ActivityController extends AbstractController {
	...
	public function registerRoutes(): void {
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getEntityActivity' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getUserActivity' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getMyActivity' ),
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getTimeline' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				...
				'callback'            => array( $this, 'cleanupOldActivity' ),
	...
	public function getItems( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		foreach ( $items as &$item ) {
			...
			$item->user_avatar = get_avatar_url( $item->user_id, array( 'size' => 40 ) );
		}
	...
	public function getEntityActivity( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		return $this->success( $activity ?: array() );
	}
	...
	public function getTimeline( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		foreach ( $activity as $item ) {
			...
			$item->user_avatar   = get_avatar_url( $item->user_id, array( 'size' => 32 ) );
			$timeline[ $hour ][] = $item;
		}
