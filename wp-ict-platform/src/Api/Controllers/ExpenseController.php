...
class ExpenseController extends AbstractController
{
    ...
    public function registerRoutes(): void
    {
        ...
        register_rest_route(
            ...
            [
                [
                    ...
                    'permission_callback' => [$this, 'canViewExpenses'],
        ...
        register_rest_route(
            ...
            [
                [
                    ...
                    'permission_callback' => [$this, 'canViewExpense'],
                ],
                [
                    'methods'             => WP_REST_Server::EDITABLE,
                    'callback'            => [$this, 'updateItem'],
                    'permission_callback' => [$this, 'canEditExpense'],
                ],
                [
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::CREATABLE,
                'callback'            => [$this, 'approveExpense'],
                'permission_callback' => [$this, 'canApproveExpenses'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::CREATABLE,
                'callback'            => [$this, 'reimburseExpense'],
                'permission_callback' => [$this, 'canApproveExpenses'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [$this, 'getPendingExpenses'],
                'permission_callback' => [$this, 'canApproveExpenses'],
            ]
        );
    ...
    public function updateItem(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        $updateable = ['project_id', 'expense_date', 'category', 'vendor', 'description', 'amount', 'payment_method', 'is_billable', 'notes', 'receipt_path'];
        $data = [];
        ...
        $wpdb->update(ICT_EXPENSES_TABLE, $data, ['id' => $id]);
    ...
    public function deleteItem(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        $wpdb->delete(ICT_EXPENSES_TABLE, ['id' => $id]);
    ...
    public function rejectExpense(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        // Notify technician
        $this->notifyUser($expense->technician_id, 'expense_rejected', $expense, ['reason' => $reason]);
    ...
    private function notifyManagers(string $type, object $expense): void
    {
        ...
        $managers = get_users(['role' => 'ict_project_manager']);

        foreach ($managers as $manager) {
            $wpdb->insert(ICT_NOTIFICATIONS_TABLE, [
                'user_id'     => $manager->ID,
                'type'        => $type,
     ...
     * @return void
     */
    private function notifyUser(int $user_id, string $type, object $expense, array $extra = []): void
    {
        global $wpdb;
