...
class FleetController extends AbstractController {
	...
	public function registerRoutes(): void {
		...
		register_rest_route(
			...
			array(
				...
				array(
					...
					'permission_callback' => array( $this, 'canManageFleet' ),
				),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::CREATABLE,
				'callback'            => array( $this, 'updateLocation' ),
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getLocationHistory' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getMapData' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::CREATABLE,
				'callback'            => array( $this, 'assignVehicle' ),
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::CREATABLE,
				'callback'            => array( $this, 'logService' ),
				'permission_callback' => array( $this, 'canManageFleet' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getDueService' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
		...
		register_rest_route(
			...
			array(
				'methods'             => WP_REST_Server::READABLE,
				'callback'            => array( $this, 'getExpiringDocuments' ),
				'permission_callback' => array( $this, 'canViewProjects' ),
			)
		);
	...
	public function updateItem( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		foreach ( $updateable as $field ) {
			if ( $request->has_param( $field ) ) {
				...
				if ( in_array( $field, array( 'year', 'current_mileage', 'service_interval_miles' ) ) ) {
		...
		$wpdb->update( ICT_FLEET_TABLE, $data, array( 'id' => $id ) );
	...
	public function deleteItem( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		$wpdb->delete( ICT_FLEET_LOCATIONS_TABLE, array( 'vehicle_id' => $id ) );
		...
		// Delete vehicle
		$wpdb->delete( ICT_FLEET_TABLE, array( 'id' => $id ) );
	...
	public function getMapData( WP_REST_Request $request ): WP_REST_Response|WP_Error {
		...
		return $this->success( $vehicles ?: array() );
	}
