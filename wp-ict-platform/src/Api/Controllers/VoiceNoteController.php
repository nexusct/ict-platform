...
class VoiceNoteController extends AbstractController
{
    ...
    public function registerRoutes(): void
    {
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::READABLE,
                'callback'            => [$this, 'getProjectVoiceNotes'],
                'permission_callback' => [$this, 'canViewProjects'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                'methods'             => WP_REST_Server::CREATABLE,
                'callback'            => [$this, 'requestTranscription'],
                'permission_callback' => [$this, 'canManageProjects'],
            ]
        );
        ...
        register_rest_route(
            ...
            [
                ...
                'callback'            => [$this, 'updateTranscription'],
                'permission_callback' => [$this, 'canManageProjects'],
            ]
        );
    ...
    public function deleteItem(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        $wpdb->delete(ICT_VOICE_NOTES_TABLE, ['id' => $id]);
    ...
    public function getProjectVoiceNotes(WP_REST_Request $request): WP_REST_Response|WP_Error
    {
        ...
        return $this->success($voice_notes ?: []);
    }
